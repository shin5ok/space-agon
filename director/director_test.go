...
import (
	...
	mock_pb "github.com/googleforgames/space-agon/test/mock_openmatch_backend"
...
func Test_Run(t *testing.T) {
	...
	mockFetchClient := mock_pb.NewMockBackendService_FetchMatchesClient(ctrl)
	...
	mockServiceClient := mock_pb.NewMockBackendServiceClient(ctrl)
	...
	func(t *testing.T, client *mock_pb.MockBackendServiceClient) {
		t.Helper()
		r := Client{
